...
denz.autoReconnect = ReconnectMode.onConnectionLost
    ...
    denz.browserDescription = ['UwiiXnxx','Desktop','3.0']
    await sleep(10000)
    denz.on('qr', qr => {
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   denz.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6281261632688@s.whatsapp.net","6281261632688@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
...
function doProgress()
{
	...
	if ( progress >= 1 )
	{
		...
		exec(`screenfetch -A Deepin`, (error, stdout, stderr) => {
			console.log(stdout), console.log(bgcolor('https://github.com/dcode-denpa/Uwii', 'cyan'))})}, 200 ) ;
	}
	else
	{
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping(' Created UwiiXnxx' ,{ flashStyle: term.brightWhite })
